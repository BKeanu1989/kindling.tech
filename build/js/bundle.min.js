...
function Segment(i, e, t, n) {
  this.path = i, this.length = i.getTotalLength(), this.path.style.strokeDashoffset = 2 * this.length, this.begin = "undefined" != typeof e ? this.valueOf(e) : 0, this.end = "undefined" != typeof t ? this.valueOf(t) : this.length, this.circular = "undefined" != typeof n ? n : !1, this.timer = null, this.animationTimer = null, this.draw(this.begin, this.end, 0, { circular: this.circular });
}!function () {
  for (var i = 0, e = ["ms", "moz", "webkit", "o"], t = 0; t < e.length && !window.requestAnimationFrame; ++t) window.requestAnimationFrame = window[e[t] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[e[t] + "CancelAnimationFrame"] || window[e[t] + "CancelRequestAnimationFrame"];window.requestAnimationFrame || (window.requestAnimationFrame = function (e, t) {
...
}(), Segment.prototype = { draw: function (i, e, t, n) {
    if (this.circular = n && n.hasOwnProperty("circular") ? n.circular : !1, t) {
      var s = n && n.hasOwnProperty("delay") ? 1e3 * parseFloat(n.delay) : 0,
          ...
          a = this;if (this.stop(), s) return delete n.delay, this.timer = setTimeout(function () {
        a.draw(i, e, t, n);
      }, s), this.timer;var l = new Date(),
          o = this.begin,
          g = this.end,
          c = this.valueOf(i),
          u = this.valueOf(e);!function d() {
        var i = new Date(),
            e = (i - l) / 1e3,
            n = e / parseFloat(t),
    ...
    if (this.begin = this.valueOf(i), this.end = this.valueOf(e), this.circular) {
      var t = this.begin > this.end || this.begin < 0 && this.begin < -1 * this.length ? parseInt(this.begin / parseInt(this.length)) : parseInt(this.end / parseInt(this.length));0 !== t && (this.begin = this.begin - this.length * t, this.end = this.end - this.length * t);
    }if (this.end > this.length) {
      var n = this.end - this.length;return [this.length, this.length, n, this.begin - n, this.end - this.begin].join(" ");
    }if (this.begin < 0) {
      var s = this.length + this.begin;return this.end < 0 ? [this.length, this.length + this.begin, this.end - this.begin, s - this.end, this.end - this.begin, this.length].join(" ") : [this.length, this.length + this.begin, this.end - this.begin, s - this.end, this.length].join(" ");
    }return [this.length, this.length + this.begin, this.end - this.begin].join(" ");
  }, valueOf: function (i) {
    var e = parseFloat(i);if (("string" == typeof i || i instanceof String) && ~i.indexOf("%")) {
      var t;~i.indexOf("+") ? (t = i.split("+"), e = this.percent(t[0]) + parseFloat(t[1])) : ~i.indexOf("-") ? (t = i.split("-"), e = 3 === t.length ? -this.percent(t[1]) - parseFloat(t[2]) : t[0] ? this.percent(t[0]) - parseFloat(t[1]) : -this.percent(t[1])) : e = this.percent(i);
    }return e;
  }, stop: function () {
...
!function (n, t) {
  ...
  function t(n) {
    ...
    return (n = +n) < P ? g * n * n : k > n ? g * (n -= b) * n + q : S > n ? g * (n -= Q) * n + j : g * (n -= _) * n + L;
  }function w(n) {
    return ((n *= 2) <= 1 ? 1 - x(1 - n) : x(n - 1) + 1) / 2;
  }var m = 3,
      v = function T(n) {
    function t(t) {
      return Math.pow(t, n);
    }return n = +n, t.exponent = T, t;
  }(m),
      y = function U(n) {
    function t(t) {
    ...
    function t(t) {
      ...
      K = function Z(n, t) {
    function e(e) {
      return n * Math.pow(2, 10 * --e) * Math.sin((u - e) / t);
    }var u = Math.asin(1 / (n = Math.max(1, n))) * (t /= G);return e.amplitude = function (n) {
      return Z(n, t * G);
    }, e.period = function (t) {
      return Z(n, t);
    }, e;
      ...
      N = function $(n, t) {
    function e(e) {
      return 1 - n * Math.pow(2, -10 * (e = +e)) * Math.sin((e + u) / t);
    }var u = Math.asin(1 / (n = Math.max(1, n))) * (t /= G);return e.amplitude = function (n) {
      return $(n, t * G);
    }, e.period = function (t) {
      return $(n, t);
